...
namespace EgitimPortali.Controllers
{
    ...
    public class KategoriController : ControllerBase
    {
        ...
        public IActionResult KategoriGuncelle(int categoryId, [FromBody] KategoriDto updatedCategory)
        {
            ...
            var categoryMap = _mapper.Map<Kategoriler>(updatedCategory);

            if (!_kategorilerRepository.KategoriGuncelle(categoryMap))
            {
